...
import { ensureUserBillingRow, ensureUserTenant } from "../billing/billingStore.js";
import { deepseekConfigured } from "../platform/deepseek.js";
import {
  getDeskBeats,
  recordDeskOriginalPosted,
  recordDeskReplyMarked,
} from "../desk/deskBeats.js";
import { confirmRecentOwnPosts } from "../voice/userIngest.js";
import {
  buildForYouDigest,
  countT24hSnapshots,
  MIN_T24H_SNAPSHOTS,
